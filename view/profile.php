...
<html>
    ...
    <body> 
        ...
        <div id="groundtext"><center><h1><?php echo $username; ?>'s Ground</h1></center></div>
                <div class="leftHalf">
                    <div class="notegray" id="leftuserinfo">
                        <center>
                        <br>
                            ...
                            while($row = $result->fetch_assoc()) { ?>
                                <div class='commentRight' style='display: grid; grid-template-columns: 75% auto; padding:5px;'>
                                    <div style="word-wrap: break-word;">
                                        ...
                                        <br>
                                        <?php 
											$forbidden = array("javascript", "</script>", "<script>", "src=");
											echo validateMarkdown($row['text']); 
										?>
                                    </div>
                                    <div>
                                        <a style='float: right;' href='/view/profile?id=<?php echo getID($row['author'], $conn); ?>'><?php echo $row['author']; ?></a>
                                        <br>
                                        <img class='commentPictures' style='float: right;' height='80px;'width='80px;'src='//images.weserv.nl/?url=spacemy.xyz/dynamic/pfp/<?php echo getPFP($row['author'], $conn); ?>'>
                                    </div>
                                </div>
                        <?php } ?>
                    </div>
